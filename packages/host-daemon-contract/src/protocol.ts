...
//
// Version 172 adds the settled `thread.storage.delete` command. The daemon
// derives the exact thread directory from its own storage root, unregisters
// linked Git worktrees inside it, and then deletes the directory. Older
// daemons cannot parse or execute this lifecycle cleanup command.
//
