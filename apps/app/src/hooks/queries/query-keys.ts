...
const THREAD_TASK_DIFF_QUERY_KEY = "threadTaskDiff";
...
type ThreadTaskDiffQueryKey = readonly [
  typeof THREAD_TASK_DIFF_QUERY_KEY,
  string,
];
...
export function threadTaskDiffQueryKey(
  threadId: string,
): ThreadTaskDiffQueryKey {
  return [THREAD_TASK_DIFF_QUERY_KEY, threadId];
}
