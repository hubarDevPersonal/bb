...
export const nativeThemes: Record<BuiltInThemeId, NativeThemeModes> = {
  catppuccin: {
    light: {
      ...
      foreground: "#4c4f69",
      ink: "#4c4f69",
      inlineCodeForeground: "#4c4f69",
      input: "#bcbeca",
      muted: "#dcdde5",
      mutedForeground: "#5c5f77",
      paletteBlue: "#1e66f5",
      paletteGreen: "#40a02b",
      paletteOrange: "#df8e1d",
      palettePink: "#ea76cb",
      palettePurple: "#8839ef",
      paletteYellow: "#fe640b",
      ...
      sidebarSelected: "rgba(76, 79, 105, 0.118)",
      ...
      userMessage: "rgba(76, 79, 105, 0.05)",
      userMessageForeground: "#4c4f69",
    ...
    dark: {
      ...
      foreground: "#cdd6f4",
      ink: "#cdd6f4",
      inlineCodeForeground: "#cdd6f4",
      input: "#5e6177",
      muted: "#505267",
      mutedForeground: "#bac2de",
      paletteBlue: "#89b4fa",
      paletteGreen: "#a6e3a1",
      paletteOrange: "#f9e2af",
      palettePink: "#f5c2e7",
      palettePurple: "#cba6f7",
      paletteYellow: "#fab387",
      ...
      sidebarSelected: "rgba(205, 214, 244, 0.225)",
      ...
      userMessage: "rgba(205, 214, 244, 0.11)",
      userMessageForeground: "#cdd6f4",
  ...
  "codex-desktop": {
    light: {
      ...
      background: "#ffffff",
      border: "#d0d0d0",
      borderHairline: "#d0d0d0",
      borderSeam: "#d0d0d0",
      borderSeamVertical: "#d0d0d0",
      canvas: "#ffffff",
      card: "#ffffff",
      ...
      foreground: "#0d0d0d",
      ink: "#0d0d0d",
      inlineCodeForeground: "#0d0d0d",
      input: "#aeaeae",
      muted: "#e0e0e0",
      mutedForeground: "#7c7c7c",
      paletteBlue: "#3a83f7",
      paletteGreen: "#53b559",
      paletteOrange: "#ee7c37",
      palettePink: "#f077af",
      palettePurple: "#a67df2",
      paletteYellow: "#f6c543",
      pillForeground: "#0d0d0d",
      pillIcon: "#0d0d0d",
      pillSurfaceBorder: "#d0d0d0",
      ...
      sidebarSelected: "rgba(13, 13, 13, 0.118)",
      stateActive: "rgba(13, 13, 13, 0.118)",
      stateHover: "rgba(13, 13, 13, 0.059)",
      subtleForeground: "#9d9d9d",
      success: "#53b559",
      successForeground: "#2d512e",
      surfaceAttention: "rgba(246, 197, 67, 0.14)",
      surfaceDestructive: "rgba(255, 0, 42, 0.06)",
      surfaceDestructiveBorder: "rgba(255, 0, 42, 0.25)",
      surfaceGrouped: "#f4f4f4",
      surfaceGroupedCell: "#ffffff",
      surfaceRaised: "rgba(13, 13, 13, 0.025)",
      surfaceRaisedSolid: "#f8f8f8",
      surfaceRecessed: "rgba(13, 13, 13, 0.05)",
      surfaceRecessedSoftSolid: "#f3f3f3",
      surfaceRecessedSolid: "#f4f4f4",
      surfaceScrim: "rgba(255, 255, 255, 0.92)",
      surfaceSelected: "rgba(58, 131, 247, 0.16)",
      surfaceSelectedBorder: "rgba(58, 131, 247, 0.35)",
      timelineAccent: "#3a83f7",
      userMessage: "rgba(13, 13, 13, 0.05)",
      userMessageForeground: "#0d0d0d",
      versionUpgrade: "#141414",
      warning: "#ee7c37",
      warningText: "#b84d00",
    },
    dark: {
      ...
      attention: "#f6c543",
      background: "#212121",
      border: "rgba(255, 255, 255, 0.149)",
      borderHairline: "rgba(255, 255, 255, 0.102)",
      borderSeam: "rgba(255, 255, 255, 0.051)",
      borderSeamVertical: "rgba(255, 255, 255, 0.051)",
      canvas: "#212121",
      card: "#212121",
      cardForeground: "#ffffff",
      destructive: "#ff002a",
      destructiveForeground: "#ffffff",
      destructiveText: "#ff8583",
      diffAdded: "#53b559",
      diffRemoved: "#ff6764",
      fileAccent: "#63a8f8",
      foreground: "#ffffff",
      ink: "#ffffff",
      inlineCodeForeground: "#f1a275",
      input: "rgba(255, 255, 255, 0.149)",
      muted: "#414141",
      ...
      pillIcon: "#ffffff",
      pillSurfaceBorder: "rgba(255, 255, 255, 0.149)",
      pillSurfaceSelectedBorder: "#525252",
      popover: "#212121",
      popoverForeground: "#ffffff",
      prMerged: "#a67df2",
      primary: "#3a83f7",
      primaryForeground: "#ffffff",
      readbackForeground: "#afafaf",
      resourceSourceShelfCardHoverBorder: "#5c5c5c",
      ring: "rgba(255, 255, 255, 0.251)",
      secondary: "#303030",
      secondaryForeground: "#ffffff",
      shadowColor: "rgba(0, 0, 0, 0.4)",
      sidebar: "#1b1b1b",
      sidebarAccent: "rgba(65, 65, 65, 0.6)",
      sidebarAccentForeground: "#ffffff",
      sidebarBorder: "rgba(255, 255, 255, 0.051)",
      sidebarForeground: "#ffffff",
      sidebarRing: "#3a83f7",
      sidebarSearchMatch: "#423c2d",
      sidebarSearchMatchBorder: "#5a4f34",
      sidebarSelected: "#394a5b",
      stateActive: "rgba(255, 255, 255, 0.14)",
      stateHover: "rgba(255, 255, 255, 0.09)",
      subtleForeground: "#afafaf",
      success: "#53b559",
      successForeground: "#b5dfb5",
      surfaceAttention: "rgba(246, 197, 67, 0.12)",
      surfaceDestructive: "rgba(255, 0, 42, 0.08)",
      surfaceDestructiveBorder: "rgba(255, 0, 42, 0.3)",
      surfaceGrouped: "#212121",
      surfaceGroupedCell: "#4d4d4d",
      surfaceRaised: "#303030",
      surfaceRaisedSolid: "#303030",
      surfaceRecessed: "#1b1b1b",
      surfaceRecessedSoftSolid: "#474747",
      surfaceRecessedSolid: "#1b1b1b",
      surfaceScrim: "rgba(33, 33, 33, 0.92)",
      surfaceSelected: "rgba(65, 65, 65, 0.6)",
      surfaceSelectedBorder: "rgba(255, 255, 255, 0.051)",
      timelineAccent: "#63a8f8",
      userMessage: "#1e3d74",
      userMessageForeground: "#f6fafe",
      versionUpgrade: "#f5f5f5",
      warning: "#ee7c37",
      warningText: "#f1a275",
    },
  },
  default: {
    light: {
      ...
      foreground: "#000000",
      ink: "#000000",
      inlineCodeForeground: "#000000",
      input: "#a0a0a0",
      muted: "#dbdbdb",
      mutedForeground: "#666666",
      paletteBlue: "#1f5ca6",
      paletteGreen: "#34c759",
      paletteOrange: "#ff9500",
      palettePink: "#9b349b",
      palettePurple: "#7847d0",
      paletteYellow: "#ffcc00",
      ...
      sidebarSearchMatch: "#f8eed8",
      sidebarSearchMatchBorder: "#f3e3be",
      sidebarSelected: "rgba(0, 0, 0, 0.118)",
    ...
    dark: {
      ...
      foreground: "#ffffff",
      ink: "#ffffff",
      inlineCodeForeground: "#ffffff",
      input: "#484848",
      muted: "#333333",
      mutedForeground: "#8c8c8c",
      paletteBlue: "#3c88dc",
      paletteGreen: "#30d158",
      paletteOrange: "#ff9f0a",
      palettePink: "#d670d6",
      palettePurple: "#a27dfa",
      paletteYellow: "#ffd60a",
      pillForeground: "#ffffff",
      pillIcon: "#ffffff",
      ...
      sidebarSelected: "rgba(255, 255, 255, 0.225)",
      ...
      userMessage: "rgba(255, 255, 255, 0.11)",
  ...
  dracula: {
    light: {
      ...
      foreground: "#282a36",
      ink: "#282a36",
      inlineCodeForeground: "#282a36",
      input: "#b3b5bd",
      muted: "#dddee5",
      mutedForeground: "#5f616c",
      paletteBlue: "#bd93f9",
      paletteGreen: "#2c7a4b",
      paletteOrange: "#b8762e",
      palettePink: "#ff92df",
      palettePurple: "#7d5bbe",
      paletteYellow: "#9a7d00",
      ...
      sidebarSelected: "rgba(40, 42, 54, 0.118)",
      ...
      userMessage: "rgba(40, 42, 54, 0.05)",
      userMessageForeground: "#282a36",
    ...
    dark: {
      ...
      foreground: "#f8f8f2",
      ink: "#f8f8f2",
      inlineCodeForeground: "#f8f8f2",
      input: "#73757f",
      muted: "#636570",
      mutedForeground: "#b2b4bc",
      paletteBlue: "#bd93f9",
      paletteGreen: "#50fa7b",
      paletteOrange: "#ffb86c",
      palettePink: "#ff92df",
      palettePurple: "#bd93f9",
      paletteYellow: "#f1fa8c",
      ...
      sidebarSelected: "rgba(248, 248, 242, 0.225)",
      ...
      userMessage: "rgba(248, 248, 242, 0.11)",
      userMessageForeground: "#f8f8f2",
  ...
  gruvbox: {
    light: {
      ...
      foreground: "#3c3836",
      ink: "#3c3836",
      inlineCodeForeground: "#3c3836",
      input: "#bdb699",
      muted: "#e4dbb6",
      mutedForeground: "#6e6b5e",
      paletteBlue: "#458588",
      paletteGreen: "#79740e",
      paletteOrange: "#d65d0e",
      palettePink: "#d3869b",
      palettePurple: "#8f3f71",
      paletteYellow: "#b57614",
      ...
      sidebarSelected: "rgba(60, 56, 54, 0.118)",
      ...
      userMessage: "rgba(60, 56, 54, 0.05)",
      userMessageForeground: "#3c3836",
    ...
    dark: {
      ...
      foreground: "#ebdbb2",
      ink: "#ebdbb2",
      inlineCodeForeground: "#ebdbb2",
      input: "#6f6a5b",
      muted: "#605c51",
      mutedForeground: "#aba085",
      paletteBlue: "#458588",
      paletteGreen: "#b8bb26",
      paletteOrange: "#fe8019",
      palettePink: "#d3869b",
      palettePurple: "#d3869b",
      paletteYellow: "#fabd2f",
      ...
      sidebarSelected: "rgba(235, 219, 178, 0.225)",
      ...
      userMessage: "rgba(235, 219, 178, 0.11)",
      userMessageForeground: "#ebdbb2",
  ...
  nord: {
    light: {
      ...
      foreground: "#2e3440",
      ink: "#2e3440",
      inlineCodeForeground: "#2e3440",
      input: "#afb3bb",
      muted: "#d5d8de",
      mutedForeground: "#616772",
      paletteBlue: "#81a1c1",
      paletteGreen: "#6f9655",
      paletteOrange: "#d08770",
      palettePink: "#b48ead",
      palettePurple: "#9d7cb8",
      paletteYellow: "#ebcb8b",
      ...
      sidebarSelected: "rgba(46, 52, 64, 0.118)",
      ...
      userMessage: "rgba(46, 52, 64, 0.05)",
      userMessageForeground: "#2e3440",
    ...
    dark: {
      ...
      sidebarSelected: "rgba(216, 222, 233, 0.225)",
      ...
      userMessage: "rgba(216, 222, 233, 0.11)",
      userMessageForeground: "#d8dee9",
  ...
  solarized: {
    light: {
      ...
      foreground: "#073642",
      ink: "#073642",
      inlineCodeForeground: "#073642",
      input: "#b0bba5",
      muted: "#e1e0ca",
      mutedForeground: "#496e67",
      paletteBlue: "#268bd2",
      paletteGreen: "#718c00",
      paletteOrange: "#cb4b16",
      palettePink: "#6c71c4",
      palettePurple: "#6c71c4",
      paletteYellow: "#b58900",
      ...
      sidebarSelected: "rgba(7, 54, 66, 0.118)",
      ...
      userMessage: "rgba(7, 54, 66, 0.05)",
      userMessageForeground: "#073642",
    ...
    dark: {
      ...
      sidebarSelected: "rgba(147, 161, 161, 0.225)",
      ...
      userMessage: "rgba(147, 161, 161, 0.11)",
      userMessageForeground: "#93a1a1",
