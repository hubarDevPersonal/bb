...
- Organize by project, by machine, chronologically, or by state (Action needed, Running, Done, with each Done thread's `+N −M` diff), with sort by updated, created, or title.
